...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.name_menue = QtWidgets.QComboBox(parent=self.centralwidget)
        self.name_menue.setGeometry(QtCore.QRect(130, 570, 151, 26))
        self.name_menue.setObjectName("name_menue")
        ...
        self.personality_label.setGeometry(QtCore.QRect(60, 490, 121, 31))
        ...
        self.birthday_label.setGeometry(QtCore.QRect(230, 450, 121, 31))
